    ...
    return k.add([
        ...
        k.offscreen({ destroy: true, distance: 100 }),
        {
            ...
            setBehavior(this: GameObj) {
                const currentAnim = this.getCurAnim().name === "flight-side" ? "flight-diagonal" : "flight-side";
                ...
                this.onStateUpdate("fly", () => {
                    if (this.flyTimer < this.timeBeforeEscape && (this.pos.x > k.width() + 10 || this.pos.x < -10)) {
